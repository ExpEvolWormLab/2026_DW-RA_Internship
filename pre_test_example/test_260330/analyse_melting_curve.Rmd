...
design = read_xlsx(paste0("260330_DWRA_design.xlsx"))
```
...
rawd = readHRM(paste0("260330_DWRA_melting.txt"))
```
...
df <- read.table("260330_DWRA_calibration_ampli.txt", header = TRUE, sep = "\t")
write.table(df, "260330_DWRA_calibration_ampli_2.txt", sep = "\t", dec = ",", row.names = FALSE)
ampli = readAmpli("260330_DWRA_calibration_ampli_2.txt")
