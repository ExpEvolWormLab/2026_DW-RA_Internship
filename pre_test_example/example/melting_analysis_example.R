...
design = read_xlsx(paste0(path,"example_design_plate384.xlsx"))
...
rawd = readHRM(paste0(path,"melting_example.txt"))
...
ampli = readAmpli( paste0(path, "ampli_example.txt"))
...
plot.melting.phase2(normd = normd, id = "plate1#A1") #Purple = heteroduplex; red = mutant; blue = wild-type.
